...
class Armario(pygame.sprite.Sprite):
    ...
    def __init__(self, *groups):
        ...
        self.sprite1 = pygame.image.load("data/armario.png").convert_alpha()
        self.sprite2 = pygame.image.load("data/armario1.png").convert_alpha()
        ...
        self.image = pygame.image.load("data/armario1.png")
